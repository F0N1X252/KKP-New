...
class Ticket extends Model
{
    ...
    // Jika ada $guarded, pastikan author_name & author_email tidak ada di sini
    protected $guarded = [];
    
    // Atau jika ada $fillable, pastikan author_name & author_email ADA di sini
    protected $fillable = [
        'title',
        'content',
        'status_id',
        'priority_id',
        'category_id',
        'author_name',    // <-- HARUS ADA
        'author_email',   // <-- HARUS ADA
        'assigned_to_user_id',
        'attachment', // untuk upload file Laravel standar
        'created_at',
        'updated_at',
        'deleted_at',
    ];
