...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h4 class="fw-bold m-0">Edit Status</h4>
                <div class="text-muted small">Update status definition</div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" class="form-control form-control-lg {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $status->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="color" name="color" class="form-control form-control-lg colorpicker {{ $errors->has('color') ? 'is-invalid' : '' }}" value="{{ old('color', $status->color) }}">
                                <span class="input-group-text color-preview-addon">
                                    <!-- Preview box langsung menggunakan warna dari database -->
                                    <i class="color-preview-box" style="background-color: {{ old('color', $status->color ?? '#FFFFFF') }};"></i>
                                </span>
                            </div>
                            @if($errors->has('color'))
